...
\begin{document}
    ...
    %
    \mysection{Abstract}
    This report summarizes everything the development-process during a project which
    develops an application for the \textit{"Samsung Galaxy Watch"} using the proprietary development-studio
    \textit{Tizen studio} to allow control and monitoring of open-source FDM-3D-Printers.
    \\\\
    The project does require design iterations and time beyond the timespan of this course, and this will therefore
    ...
    \\
    I wish to asseverate the importance of clarity which \textit{Snorre Kim} brought me, while assisting in the
    design and layout process.
    \\
    Lastly I wish to acknowledge my mentor \textit{Jaakko Järvi} for the freedom and professionalism he has provided
