...
\begin{document}
    ...
    an application for the \textit{"Samsung Galaxy Watch"} using the proprietary IDE
    \textit{Tizen studio} to allow control and monitoring of the most common open source 3D printers.
    \\\\
    Since the project does require design iterations and time beyond the timespan of this course, this will therefore
